...
def visualize(data, short_period, long_period):
    ...
    # print(plot_sells.index)
    # print(plot_sells['Close'])
    data.plot(color='black')
    plot_sells.plot(kind='scatter', x='Date', y='Close', color='red')
    plot_buys.plot(kind='scatter', x='Date', y='Close', color='green')
    plt.show()
